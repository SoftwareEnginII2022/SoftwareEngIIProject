...
def upload_Picture(user_id, profile_id, url, likes, dislikes):
    new_Picture = Picture(user_id = user_id, profile_id = profile_id, url = url, likes = likes, dislikes= dislikes),
